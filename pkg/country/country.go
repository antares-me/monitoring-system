...
// IsRightCode проверяет является ли переданный код кодом из списка стран
func IsRightCode(code string) bool {
	_, ok := countryCodes[code]
	return ok
}

// ReplaceCountruCode возвращает название страны по коду ISO 3166-1 alpha-2
func ReplaceCountruCode(code string) string {
